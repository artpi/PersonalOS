...
- Split packages are also private WpApp applications: Notes at `/notes/`, TODO at `/todo/`, AI Chat at `/ai-chat/`, Readwise at `/readwise/`, and Evernote at `/evernote/`. Keep WpApp as a presentation layer over existing REST/Abilities/Knowledge contracts, pin and bundle WpApp 1.3.2 in every standalone ZIP, and declare PHP 7.4 because that is the runtime's minimum.
